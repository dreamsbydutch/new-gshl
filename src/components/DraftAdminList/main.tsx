/**
 * DraftAdminList (presentational component)
 * ----------------------------------------
 * UI wrapper for the Draft Admin experience. Delegates data fetching and
 * business rules to the `useDraftAdminList` hook while rendering the table
 * controls, current pick summary, and draft/undo actions.
 */
...
/**
 * Administrative draft dashboard listing signable free agents and exposing
 * quick actions for the current pick. All data and behavior is provided by
 * {@link useDraftAdminList}, keeping this component purely presentational.
 */
