...
function TvFrame({ title, children }: { title: string; children: ReactNode }) {
  return (
    <main className="flex h-dvh min-h-[500px] flex-col overflow-hidden bg-white p-3 text-[length:clamp(16px,1.35vw,52px)] leading-tight text-slate-950">
      <header className="mb-3 flex shrink-0 items-center justify-between border-b border-slate-300 pb-2">
  ...
  return (
    ...
    >
      <div ref={contentRef} className="w-full">
        <CompactBestAvailableTable title={title} players={players} />
