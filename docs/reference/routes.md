...
| -------------------------- | ------------------------ | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/`                        | Public                   | `HomeContent`                                 | Full-width season-aware League Wire followed by compact UFA, draft, and offseason decision surfaces.                                                |
...
- Normal routes use `AppShell`, one `MainNavbar`, and one global season bar. Mobile renders a route-aware header plus labeled Home, Schedule, Standings, My Team, and More destinations; large screens render the same information architecture in a top bar. Historical season context is highlighted and includes a direct return to the current season.
