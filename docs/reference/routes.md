...
| `/draft`                        | Active user              | `DraftHubBoard` in `DraftHubLayout`           | Transactional live draft board with compact comparison tables at every width, frozen player names and row actions, sortable stats, and selection confirmation.                                                                                                                                                                                                                    |
...
| `/draft-roster-board/live`      | Public, `noindex`        | `DraftLiveTvBoard`                            | Read-only draft flow: active team and clock across the top, height-fitted recent picks descending on the left, current-owner roster in the center, and height-fitted upcoming picks ascending on the right. Before the draft, shows the first team and start countdown.                                                                                                           |
