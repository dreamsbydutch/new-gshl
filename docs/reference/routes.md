...
| `/draft-roster-board/available` | Public, `noindex`        | `DraftAvailableTvBoard`                       | Shell-free companion TV with larger top-26 skater and top-8 goalie comparison tables.                                                                                                                                                                                                                                                                                             |
| `/draft-roster-board/live`      | Public, `noindex`        | `DraftLiveTvBoard`                            | Read-only draft flow: active team and clock across the top, five recent picks descending on the left, current-owner roster in the center, and five upcoming picks ascending on the right. Before the draft, shows the first team and start countdown.                                                                                                                             |
