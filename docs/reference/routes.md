...
| `/draft-roster-board`           | Public, `noindex`        | `DraftRosterBoard`                            | Dimmed, header-free conference roster overview with a center switch between an expanded active-owner ladder and the live clock/recent/upcoming picks. Remaining round-overall pick labels appear below each roster and disappear on selection. Abbreviated names and fitted text keep each team in its panel; center-panel links open the companion screens. |
