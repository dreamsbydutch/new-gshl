...
| `/draft-roster-board`           | Public, `noindex`        | `DraftRosterBoard`                            | Dimmed, header-free conference roster overview with the active-owner career ladder in the center. Abbreviated names and fitted text keep all rosters visible without scrolling; center-panel links open the companion screens.                        |
| `/draft-roster-board/available` | Active user, `noindex`   | `DraftAvailableTvBoard`                       | Shell-free companion TV with larger top-26 skater and top-8 goalie comparison tables.                                                                                                                                                                 |
| `/draft-roster-board/live`      | Active user, `noindex`   | `DraftLiveTvBoard`                            | Read-only draft flow: active team and clock across the top, five recent picks descending on the left, current-owner roster in the center, and five upcoming picks ascending on the right. Before the draft, shows the first team and start countdown. |
...
- `/draft-roster-board` and its companion TV routes bypass the shell entirely.
