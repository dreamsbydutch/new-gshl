...
| `/draft-roster-board/available` | Public, `noindex`        | `DraftAvailableTvBoard`                       | Shell-free companion TV with as many ranked skaters as the display height supports, the top 10 goalies, and a 14-team roster-makeup table counting C, LW, RW, D, and G eligibility.                                                                                                                                                                                                                           |
