...
| `/draft-roster-board`           | Public, `noindex`        | `DraftRosterBoard`                            | Shell-free conference rosters and best available, linked as TV board from Draft. First-initial player names and viewport-scaled text fitted to each panel keep full rosters and all best-available columns on one screen without scrolling. |
...
| `/draft-roster-board/live`      | Active user, `noindex`   | `DraftLiveTvBoard`                            | Read-only live clock, current team's roster, last five picks, and next three teams.                                                                                                                                                         |
