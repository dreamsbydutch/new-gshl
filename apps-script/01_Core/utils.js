 ...
 *
 * Note: This file intentionally exposes only one global: `GshlUtils`.
 * All helpers are encapsulated and must be accessed via that namespace.
 */

// @ts-nocheck

var GshlUtils = (function buildGshlUtilsNamespace() {
  ...
  function isDryRunModeEnabled() {
    var fallback =
      typeof ENABLE_DRY_RUN_MODE === "undefined"
        ? false
        : !!ENABLE_DRY_RUN_MODE;
  ...
  /**
   * Normalize/validate a season id input as a trimmed string.
   *
   * @param {any} seasonId
   * @param {string=} callerName Optional label for error messages.
   * @returns {string}
   */
    ...
    var resolved =
      seasonId === undefined || seasonId === null
        ...
        : typeof seasonId === "string"
          ...
          : String(seasonId);
    if (!resolved) {
      var label = callerName ? String(callerName) : "caller";
      throw new Error(label + " requires a seasonId argument");
    }
    return resolved;
  }
  ...
  function groupAndApplyColumnUpdates(sheet, colIndex1Based, updates) {
    ...
    for (var i = 1; i < updates.length; i++) {
      ...
      if (curr.rowIndex === prev + 1) {
        ...
        sheet
          .getRange(start, colIndex1Based, buffer.length, 1)
          .setValues(buffer);
        start = curr.rowIndex;
        buffer = [[curr.value]];
      }
  ...
  function upsertSheetByKeys(
    ...
    var dryRunMode = isDryRunModeEnabled();
  ...
  var api = {
    core: {
      env: {
        getScriptPropertiesSnapshot: getScriptPropertiesSnapshot,
        coerceBooleanFlag: coerceBooleanFlag,
        getEnvironmentFlag: getEnvironmentFlag,
        isVerboseLoggingEnabled: isVerboseLoggingEnabled,
        isDryRunModeEnabled: isDryRunModeEnabled,
      },
      constants: {
        SeasonType: SeasonType,
        TEAM_STAT_FIELDS: TEAM_STAT_FIELDS,
        MATCHUP_CATEGORY_RULES: MATCHUP_CATEGORY_RULES,
        GOALIE_CATEGORY_SET: GOALIE_CATEGORY_SET,
        GOALIE_START_MINIMUM: GOALIE_START_MINIMUM,
        PLAYER_DAY_STAT_FIELDS: PLAYER_DAY_STAT_FIELDS,
      },
      log: {
        verbose: logVerbose,
      },
      date: {
        ...
        getTargetDateForScraping: getTargetDateForScraping,
        getPreviousDate: getPreviousDate,
        getNextDate: getNextDate,
        getDatesInRangeInclusive: getDatesInRangeInclusive,
        isDateInRange: isDateInRange,
      },
      text: {
        removeAccents: removeAccents,
        applyNameVariations: applyNameVariations,
      ...
      parse: {
        ...
        extractFirstArrayValue: extractFirstArrayValue,
      },
    },

    sheets: {
      types: {
        SHEET_DATE_ONLY_FIELDS: SHEET_DATE_ONLY_FIELDS,
        SHEET_DATETIME_FIELDS: SHEET_DATETIME_FIELDS,
        SHEET_BOOLEAN_FIELDS: SHEET_BOOLEAN_FIELDS,
        SHEET_NUMERIC_FIELDS: SHEET_NUMERIC_FIELDS,
        SHEET_SCHEMAS: SHEET_SCHEMAS,
        SHEET_TYPE_OVERRIDES: SHEET_TYPE_OVERRIDES,
        PLAYER_DAY_NUMERIC_FIELDS: PLAYER_DAY_NUMERIC_FIELDS,
        PLAYER_WEEK_NUMERIC_FIELDS: PLAYER_WEEK_NUMERIC_FIELDS,
        TEAM_DAY_NUMERIC_FIELDS: TEAM_DAY_NUMERIC_FIELDS,
        TEAM_WEEK_NUMERIC_FIELDS: TEAM_WEEK_NUMERIC_FIELDS,
        TEAM_SEASON_NUMERIC_FIELDS: TEAM_SEASON_NUMERIC_FIELDS,
        createSheetSchema: createSheetSchema,
        buildSheetTypeOverrides: buildSheetTypeOverrides,
        getSheetSchema: getSheetSchema,
        getSheetKeyColumns: getSheetKeyColumns,
        resolveFieldType: resolveFieldType,
        coerceSheetValue: coerceSheetValue,
        stringifySheetValue: stringifySheetValue,
      },
      open: {
      ...
      read: {
        ...
        fetchSheetAsObjects: fetchSheetAsObjects,
        extractSheetTableData: extractSheetTableData,
        inferHeaderRowIndex: inferHeaderRowIndex,
      },
      write: {
    ...
    yahoo: {
      ...
      roster: {
        ...
        normalizeNhlPosValue: normalizeNhlPosValue,
        resolvePosGroupFromNhlPos: resolvePosGroupFromNhlPos,
        buildMissingPlayerDayRow: buildMissingPlayerDayRow,
      },
    },

    domain: {
      matchups: {
        matchupHasOutcome: matchupHasOutcome,
      },
      players: {
        isStarter: isStarter,
        calculateAgeWithDecimal: calculateAgeWithDecimal,
      },
      workbooks: {
  ...
  // Best-effort immutability (safe in V8; ignored if unavailable)
  try {
    Object.freeze(api.core.env);
    Object.freeze(api.core.constants);
    Object.freeze(api.core.log);
    Object.freeze(api.core.date);
    Object.freeze(api.core.text);
    Object.freeze(api.core.parse);
    Object.freeze(api.core);
    Object.freeze(api.sheets.types);
    Object.freeze(api.sheets.open);
    Object.freeze(api.sheets.read);
    Object.freeze(api.sheets.write);
    Object.freeze(api.sheets);
    Object.freeze(api.yahoo.html);
    Object.freeze(api.yahoo.roster);
    Object.freeze(api.yahoo);
    Object.freeze(api.domain.matchups);
    Object.freeze(api.domain.players);
    Object.freeze(api.domain.workbooks);
    Object.freeze(api.domain.weeks);
    Object.freeze(api.domain);
    Object.freeze(api);
  } catch (e) {
    // no-op
  }
