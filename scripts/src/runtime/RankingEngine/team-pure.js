...
(function (ns) {
  ...
  function ensureDeps() {
    ...
    TEAM_DAY_NO_GOALIE_CATEGORY_SCORE = deps.TEAM_DAY_NO_GOALIE_CATEGORY_SCORE;
    TEAM_WEEK_NO_GOALIE_CATEGORY_SCORE =
      deps.TEAM_WEEK_NO_GOALIE_CATEGORY_SCORE;
    TEAM_DAY_FINAL_SCORE_MULTIPLIER = deps.TEAM_DAY_FINAL_SCORE_MULTIPLIER;
    TEAM_WEEK_FINAL_SCORE_MULTIPLIER = deps.TEAM_WEEK_FINAL_SCORE_MULTIPLIER;
