...
(function (ns) {
  ...
  function readSeasonCategoriesFromData(seasonId) {
    const seasonKey =
    ...
    try {
      const readModel = LeagueRuntime.readModel;
      ...
      const seasons = readModel("Season");
  ...
  function getMatchupCategoriesForSeason(seasonId) {
    const dynamicCategories = readSeasonCategoriesFromData(seasonId);
