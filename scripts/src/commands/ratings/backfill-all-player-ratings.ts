 ...
 *   npm run ratings:rebuild-all -- --season-ids 11,12 --models PlayerTotalStatLine,PlayerNHLStatLine [--apply]
 *
 * What it does:
 *   Runs the player-rating backfill across multiple seasons in sequence and
 *   prints one combined summary, including any season-level failures. Runs as a
