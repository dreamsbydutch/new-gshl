 ...
 *
 * What it does:
 *   Samples rows from one season and compares Node-computed player ratings
 *   against the Apps Script implementation, failing if mismatches exceed the
 *   allowed delta.
 *
 * Options:
 ...
 *   --max-delta <value>     Maximum allowed absolute score delta. Default: 0.01.
