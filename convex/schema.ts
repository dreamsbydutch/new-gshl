  ...
  players: table(
    {
      ...
      nhlSigningDate: dateOnlyValue,
      nhlSigningAgent: optionalNullableString,
      nhlSigningGm: optionalNullableString,
  ...
  draftPicks: table(
    {
      ...
      onClockStartedAt: timestampValue,
      onClockExpiresAt: timestampValue,
      onClockEndedAt: timestampValue,
      isTraded: boolValue,
      isSigning: boolValue,
      createdAt: timestampValue,
      updatedAt: timestampValue,
